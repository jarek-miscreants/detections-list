/**
 * @generated
 * @file ContentGrid (generated by DevLink)
 *
 ...
 * @see {@link https://detections-ai-new.design.webflow.com | Source site in Webflow}
 */
export function ContentGrid({ columnsSpan = "Base", contentSlot }) {
  ...
  return (
    ...
    >
      <Block
        className={`g_content_grid column-custom ${_activeStyleVariant}`}
        tag={"div"}
      >
        {contentSlot}
      </Block>
